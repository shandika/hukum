<?php 
    ...
    $query=$this->db->query("SELECT * FROM tbl_new_job WHERE nama_staff='$staff' AND status_inbox_staff='1'");
            ...
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li title="Pemberitahuan Masuk" role="presentation" class="dropdown">
                  ...
                  <?php 
                    $staff=$this->session->userdata('nama_user');
                    $inbox=$this->db->query("SELECT tbl_new_job.*,DATE_FORMAT(tanggal_buat,'%d %M %Y') AS tanggal FROM tbl_new_job WHERE nama_staff='$staff' AND status_inbox_staff='1' ORDER BY tanggal_buat DESC LIMIT 4");
                  ...
                  ?>
                    <li>
                      <a href="<?php echo base_url().'staff/c_staff/get_job_detail/'.$kode_voucher;?>">
